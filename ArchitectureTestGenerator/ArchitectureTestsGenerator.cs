...
public class ArchitectureTestsGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(compilationProvider, (spc, compilation) =>
        {
            ...
            if (analysisResult.Modules.Count == 0)
            {
                // No modules found, skip generation
                return;
            }
    ...
    public AnalysisResult Analyze()
    {
        ...
        foreach (var reference in _compilation.References)
        {
            if (_compilation.GetAssemblyOrModuleSymbol(reference) is IAssemblySymbol assemblySymbol)
            {
                ...
                var isProjectReference = reference is Microsoft.CodeAnalysis.PortableExecutableReference portableRef &&
                                        portableRef.FilePath != null &&
                                        !portableRef.FilePath.Contains(".nuget") &&
                                        !portableRef.FilePath.Contains("\\ref\\") &&
                                        !portableRef.FilePath.Contains("/ref/");
                ...
                // Skip system and test assemblies
                if (assemblyName.StartsWith("System") ||
                    assemblyName.StartsWith("Microsoft") ||
                    assemblyName.StartsWith("netstandard") ||
                    assemblyName.Contains("Test") ||
                    assemblyName.Contains(".Api"))
                {
                    continue;
                }
